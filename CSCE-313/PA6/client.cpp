...
int main(int argc, char *argv[])
{
    ...
    //TCPRequestChannel* chan = new TCPRequestChannel("control", TCPRequestChannel::CLIENT_SIDE);//erased this line fro video 
	...
	TCPRequestChannel** wchans  = new TCPRequestChannel* [w]; //ADDED
	for(int i = 0; i < w;i++)
    {
    ...
    //{
        ...
        thread filethread(file_thread_function, fname, &request_buffer, chan, m); //COMMENTED OUT
    //}
